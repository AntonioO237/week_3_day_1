...
print(6/2)
# #modulo
print(7%4) #remainder of 7 division by 4
# #powers
print(2**3) #2 to the power of 3
# #get the max and min of a number
print("the max of 2 and 3 is",max(2,3)) #max means the highest number
print("the min of 2 and 3 is",min(2,3)) #min means the lowest number
# #round a number
print("round 3.9 is",round(3.9))
# # absolute value
print("the aboslute value of -3 is",abs(-3))
# # order of operations
print("2 + 10 * 10 + 3 is",2 + 10 * 10 + 3) #order of operations is the same as in math, using PEMDAS

# #to do more you need to import special math libraries from python
from math import *    
# #this goes out and grabs some different math functions we can use
# #floor method
print("the floor of 3.7 is",floor(3.7)) #floor means round down 
# #ceil method
print("the ceil of 3.7 is",ceil(3.7)) #ceil means round up
# #sqrt method
